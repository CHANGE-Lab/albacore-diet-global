...
summary(probable_traits$life_stage) #we will remove larva as a value from the df, larval taxa didn't make it through the data cleaning and manipulation.

summary(probable_traits$vert_habitat) #merge bathypelagic and mesopelagic, these prey could not have been consumed in the bathypelagic anyways.

summary(probable_traits$horz_habitat) #merge of continental shelf/slope, and coastal/reef assoc, we do not have enough data to properly differentiate and represent these habitat values, so we merge and take a coarser definition of 'continental shelf & slope' and 'coastal & reef-assoc'.

summary(probable_traits$diel_migrant_cat) #a lot more diel migrants than not

summary(probable_traits$season_cat) #more seasonal taxa than not
