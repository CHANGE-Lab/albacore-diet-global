...
prey_probable_load = read.csv(here("data/output_data/prey_trait_probable_select.csv"), header=TRUE) %>% #prey_probable_traits.csv
  dplyr::select(-c(diel_migrant, refuge, season_migrant, l_max:fisheries_status)) %>% 
...
prey_probable[,6:13] = lapply(prey_probable[,6:13] , as.factor)
probable_traits = as.data.frame(prey_probable[,c(7:13)]) #12
...
write.csv(prob.stats.df.divisive, here("outputs_figures/clusters/prob_cluster_sep2021/prob.stats.df.divisive.csv"))
...
write.csv(prob.stats.df.aggl, here("outputs_figures/clusters/prob_cluster_sep2021/prob.stats.df.aggl.csv"))
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021/prob.dendro.horz.k7.png'), plot=prob.dendro.graph, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021/prob.dendro.rad.k7.png'), plot=prob.dendro.rad, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021/prob.dendro.vertlabs.k7.pdf'), plot=ggd1, width=5, height=20, dpi=300)
...
prob.dendro.vert 
#Export as .png
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021/prob.dendro.vert2.k7.png'), plot=prob.dendro.vert, width=5, height=12, dpi=300)
...
write.csv(prob.prey.cl, here("outputs_figures/clusters/prob_cluster_sep2021/prob.prey.clusternum_habgreg.divis.k7.csv"))
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021/prob.dendro.heatcounts.divis.k7.life.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021/prob.dendro.heatpercent.divis.k7.life.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
...
```{r nMDS Cluster by FO, warning=FALSE, message=TRUE}
