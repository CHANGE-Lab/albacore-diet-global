...
write.csv(prob.stats.df.divisive, here("outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.stats.df.divisive.csv"))
...
write.csv(prob.stats.df.aggl, here("outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.stats.df.aggl.csv"))
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.dendro.horz.k7.png'), plot=prob.dendro.graph, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.dendro.rad.k7.png'), plot=prob.dendro.rad, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.dendro.vertlabs.k7.pdf'), plot=ggd1, width=5, height=20, dpi=300)
...
prob.dendro.vert 
#Export as .png
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.dendro.vert2.k7.png'), plot=prob.dendro.vert, width=5, height=12, dpi=300)
...
write.csv(prob.prey.cl, here("outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.prey.clusternum_habgreg.divis.k7.csv"))
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.dendro.heatcounts.divis.k7.life.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_sep2021_nonagg/prob.dendro.heatpercent.divis.k7.life.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
...
#ggsave(here("outputs_figures/clusters/prob_cluster_sep2021/trait_nMDS_prob_clusters.png"), 
