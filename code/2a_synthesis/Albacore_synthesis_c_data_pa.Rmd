...
alb_prob_clust = read.csv(paste(here("./data/output_data/prob.prey.clusternum_aggl.k7.csv"), 
   ...
   dplyr::select(prey_sp:prob.clust.num, -prey_age_reported_1)

dim(alb_prob_clust) #we obtain 156 species,  8 traits or covariates
...
#L - species df
write.csv(alb_prob_prey, here("./data/output_data/alb_prob_preyPA_use.csv"))
