...
ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_life_cluster7_LASSO_graph.pdf"), 
       plot = as.ggplot(prob_life_cluster_LASSO_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_life_cluster7_LASSO_graph.jpeg"), 
       plot = as.ggplot(prob_life_cluster_LASSO_graph), width=12, height=12, dpi=300)
...
#ggsave(here("outputs_figures/traitglms/prob_all_simple/prob_life_many_4th_graph.jpeg"), plot = as.ggplot(prob_ocean_cluster_LASSO_graph), width=12, height=12, dpi=300)
...
#saveRDS(an_prob_lat_clusters_many, file = here("outputs_figures/traitglms/prob_models/an_prob_lat_clusters_many.rds"))
an_prob_lat_clusters_many = readRDS(file = here("outputs_figures/traitglms/prob_models/an_prob_lat_clusters_many.rds"))
...
#saveRDS(an_prob_life_trait_many, file = here("outputs_figures/traitglms/prob_models/an_prob_life_trait_many.rds"))
an_prob_life_trait_many = readRDS(file = here("outputs_figures/traitglms/prob_models/an_prob_life_trait_many.rds"))
...
#saveRDS(an_prob_ocean_trait_many, file = here("outputs_figures/traitglms/prob_models/an_prob_ocean_trait_many.rds"))
an_prob_ocean_trait_many = readRDS(file = here("outputs_figures/traitglms/prob_models/an_prob_ocean_trait_many.rds"))
...
#saveRDS(an_prob_lat_trait_many, file = here("outputs_figures/traitglms/prob_models/an_prob_lat_trait_many.rds"))
an_prob_lat_trait_many = readRDS(file = here("outputs_figures/traitglms/prob_models/an_prob_lat_trait_many.rds"))
...
#saveRDS(an_prob_inter_trait_many, file = here("outputs_figures/traitglms/prob_models/an_prob_inter_trait_many.rds"))
an_prob_inter_trait_many = readRDS(file = here("outputs_figures/traitglms/prob_models/an_prob_inter_trait_many.rds"))
...
#saveRDS(an_prob_inter_trait_many2, file = here("outputs_figures/traitglms/prob_models/an_prob_inter_trait_many2.rds"))
an_prob_inter_trait_many2 = readRDS(file = here("outputs_figures/traitglms/prob_models/an_prob_inter_trait_many2.rds"))
