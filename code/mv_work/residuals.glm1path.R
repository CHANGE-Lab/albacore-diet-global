#after email communication with david warton 20181205
#bug fixed in plotting of residuals 
#source this code to over-write the functions in the mvabund package
#downloaded from github 20181205
#https://github.com/aliceyiwang/mvabund/blob/master/R/residuals.glm1path.R
