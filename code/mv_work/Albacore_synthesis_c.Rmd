...
source("/Users/tashhardy/Documents/GitHub/albacore-diet-global/code/synthesis/traitglm.R")
source("/Users/tashhardy/Documents/GitHub/albacore-diet-global/code/synthesis/get_polys.R")
...
#we get 118 species and trait values
...
```{r Diet data manip for >1 FO, eval=FALSE, include=FALSE}
...
Cluster models for Predator Life Stage and Ocean Basin

- prob_life_clusters_many

- prob_life_clusters_spp

- prob_ocean_clusters_many 

- prob_ocean_clusters_many 

Trait models for Predator Life Stage and Ocean Basin
...
prob_test1 <- traitglm(L = alb_prob_preyPA_mv,
                                    R = prob_pred_life,
                                    Q = traits_prob_clust, 
                                      #traits_prob$cluster,
...
prob_test2 <- traitglm(L = alb_prob_preyPA_mv,
                                    R = prob_pred_life,
...
```{r TEST GREGARIOUS}
summary(traits_prob$gregarious)

prob_test3 <- traitglm(L = alb_prob_preyPA_mv,
                                    R = prob_pred_life,
                                    Q = traits_prob$gregarious, 
                                      #traits_prob$cluster,
                                    family=binomial(link = "logit")
                                    ) #note default is "manyglm"
...
```{r TEST SEASON}
summary(traits_prob$season_cat)

prob_test3 <- traitglm(L = alb_prob_preyPA_mv,
                       R = prob_pred_life,
                       Q = traits_prob$season_cat, 
                                      #traits_prob$cluster,
                                    family=binomial(link = "logit")
                                    ) #note default is "manyglm"
...
```{r TEST DIEL MIGRANT}
summary(traits_prob$diel_migrant_cat)

prob_test3 <- traitglm(L = alb_prob_preyPA_mv,
                       R = prob_pred_life,
                       Q = traits_prob$diel_migrant_cat,
                       family=binomial(link = "logit")
                       ) #note default is "manyglm"
...
```{r TEST H HAB}
summary(traits_prob$horz_habitat)

prob_test3 <- traitglm(L = alb_prob_preyPA_mv,
                       R = prob_pred_life,
                       Q = traits_prob$horz_habitat,
                       family=binomial(link = "logit")
                       ) #note default is "manyglm"
...
```{r TEST V HAB}
summary(traits_prob$vert_habitat)

prob_test3 <- traitglm(L = alb_prob_preyPA_mv,
                       R = prob_pred_life,
                       Q = traits_prob$vert_habitat,
                       family=binomial(link = "logit")
                       ) #note default is "manyglm"
...
```{r TEST PREY LIFE}
summary(traits_prob$life_stage)
...
```{r TraitGLM - SPP - life + clusters manyglm binom}

prob_life_clusters_spp <- traitglm(L = alb_prob_preyPA_mv,
                                    R = prob_pred_life,
                                    family=binomial(link = "logit")
                                    ) #note default is "manyglm"
...
a        = max( abs(prob_life_clusters_spp$fourth.corner) )
colort   = colorRampPalette(c("blue","white","red")) 
temp = t(as.matrix(prob_life_clusters_spp$fourth.corner))
...
prob_life_clusters_spp_graph = levelplot(temp, 
                     xlab=list("Predator Life Stage", cex=1.5),
...
print(prob_life_clusters_spp_graph)

```

MODEL COMP - Cluster, manyglm, predator life stage

```{r Cluster, predator life,  model comp}

#anova.traitglm(prob_life_clusters_many, prob_life_clusters_spp)
...
```{r TraitGLM - SPP - ocean + clusters manyglm binom}

prob_ocean_clusters_spp <- traitglm(L = alb_prob_preyPA_mv,
                                    R = prob_ocean,
                                    family=binomial(link = "logit")
                                    ) #note default is "manyglm"
...
#Cluster model, for cluster vs. predator life stage
#prob_life_cluster_LASSO
