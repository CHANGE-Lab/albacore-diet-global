...
#31  32  58  64  69  72  79  81  86  90 102 119 140 141 151 156 
...
#ANOVA - meant to compare models
#anova.traitglm(prob_life_clusters_many)

#Summary call
#summary.traitglm(prob_life_clusters_many)
```
...
#summary.traitglm(prob_life_cluster_LASSO)
#anova.traitglm(prob_life_cluster_LASSO)
...
ggsave(here("outputs_figures/traitglms/prob_life_cluster7_LASSO_graph.pdf"), 
       plot = as.ggplot(prob_life_cluster_LASSO_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_life_cluster7_LASSO_graph.jpeg"), 
       plot = as.ggplot(prob_life_cluster_LASSO_graph), width=12, height=12, dpi=300)
