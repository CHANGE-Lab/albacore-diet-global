...
trait_life_4th = as.ggplot(plot.4th)

ggsave(here("outputs_figures/traiglms/trait_life_4th.pdf"), plot = trait_life_4th, width=12, height=12, dpi=300)

#dev.copy2pdf(file=here("./outputs_figures/traiglms/fourth_lifestage.png"), width=12, height=5)
