...
#Check df str
#str(alb_adult_traits) #all factors? #YES
#str(alb_adult_covars) #all factors #YES
...
#All traits to try
traits_try = alb_adult_traits[,2:8]
...
adult_prey_many <- manyglm(alb_adult_prey_mv ~ ocean, family="binary")
