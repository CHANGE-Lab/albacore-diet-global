---
title: "Albacore traitglms for %FO data troubleshooting"
...
#  dplyr::select(StudyID:ncol(.), -c(grouped_id, `Diplospinus multistriatus`, `Sardina pilchardus`, `Todaropsis eblanae`, `Nyctiphanes australis`, `Euphausia pacifica`, `Anchylomera blossevillei`, `Benthosema glaciale`, `Scomber scombrus`, `Trachurus japonicus`, `Illex coindetii`, `Hyaloteuthis pelagica`, `Pteroctopus tetracirrhus`,  `Ancistroteuthis lichtensteinii`, `Histioteuthis heteropsis`, `Trachinotus ovatus`, `Scaeurgus unicirrhus`)) #, 
