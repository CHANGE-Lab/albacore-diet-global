...
traits_use = alb_trait_use[,c(4:7,9)] %>%
...
ocean_trait_many = readRDS(here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_traits_many.rds"))
...
an_ocean_trait_many = readRDS(here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_traits_many_anova.rds"))
an_ocean_full_spp = readRDS(here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_full_spp_many_anova.rds"))
```
...
#ocean_spp$deviance
an_ocean_spp = anova(ocean_spp, test = "LR", nBoot = 100)
an_ocean_spp
...
an_ocean_clusters_many = anova(ocean_clusters_many, test = "LR", nBoot = 100)
...
#note that col.intercepts = TRUE is the default
ocean_trait_many
saveRDS(ocean_trait_many, file = here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_traits_many.rds"))
```

```{r Traits ocean manyglm output, eval=FALSE}
#ocean_trait_many$deviance
an_ocean_trait_many = anova(ocean_trait_many, test = "LR", nBoot = 100)
an_ocean_trait_many
saveRDS(an_ocean_trait_many, file = here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_traits_many_anova.rds"))
...
an_ocean_full_many = anova(ocean_full_many, nBoot = 100)
an_ocean_full_many
saveRDS(an_ocean_full_many, here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_full_spp_many_anova.rds"))
...
ocean_cluster_LASSO = readRDS(here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_clusters_LASSO.rds"))
ocean_trait_LASSO = readRDS(here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_traits_LASSO.rds"))
ocean_phylo_LASSO = readRDS(here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_phylo_LASSO.rds"))
```
...
saveRDS(ocean_spp_LASSO, here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_spp_LASSO.rds"))
#note default is "manyglm"
#note that col.intercepts = TRUE is the default
```
...
saveRDS(ocean_cluster_LASSO, here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_clusters_LASSO.rds"))
#note default is "manyglm"
#note that col.intercepts = TRUE is the default
```
...
ggsave(here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_clusters_LASSO_graph.jpeg"), 
       plot = as.ggplot(ocean_cluster_LASSO_graph), width=8, height=8, dpi=300)
ggsave(here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_clusters_LASSO_graph.pdf"), 
       plot = as.ggplot(ocean_cluster_LASSO_graph), width=8, height=8, dpi=300)
```
...
saveRDS(ocean_trait_LASSO, here::here("outputs_figures/5_traitglms/ocean_models_PA/ocean_traits_LASSO.rds"))
#note default is "manyglm"
#note that col.intercepts = TRUE is the default
```
