...
write.csv(prob.stats.df.divisive,here::here("outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.stats.df.divisive.hab.csv"))

```

**Note** Divisive -- for visualising cluster number selection.

* Elbow method (29/03/2022) using habitat use inflection at 7

* Silhouette (29/03/2022) using habitat use inflection at 6 (and 7)
...
prob.div.elbow
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.div.elbow.hab.png'), 
...
prob.div.silh = ggplot(data = data.frame(t(cstats.table(prob.gower.dist, prob.divisive.clust, 20))), 
  ...
  theme(plot.title = element_text(hjust = 0.5))
prob.div.silh
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.div.silh.hab.png'), 
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.dendro.horz.k6.hab.png'), plot=prob.dendro.graph, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.dendro.rad.k6.hab.png'), plot=prob.dendro.rad, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.dendro.vertlabs.k6.hab.pdf'), plot=ggd1, width=5, height=20, dpi=300)
...
prob.dendro.vert 
#Export as .png
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.dendro.vert2.k6.hab.png'), plot=prob.dendro.vert, width=5, height=12, dpi=300)
...
write.csv(prob.prey.cl, here("outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.prey.clusternum.divis.k6.hab.csv"), row.names = FALSE)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.dendro.heatcounts.divis.k6.hab.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/prob.dendro.heatpercent.divis.k6.hab.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
...
#With all variables, gregarious and life stage
#  1   2   3   4   5   6   7 
# 54 138  11  29  47   5   8 
...
For each ordination and set of grouping variables input to data scores chunk. *Not needed in this version.*

```{r Convex hulls by cluster number, warning=FALSE, message=FALSE, eval=FALSE, include=FALSE}
...
fig3.pal <- c("#00496F", "#EDB829", "#0C7996", "#94B669", "#E97C07", "#DD4124")
show_col(fig3.pal)
...
trait_nMDS_prob_fig <- ggplot() + 
  ...
  geom_point(data=treatment.scores, 
             aes(x=NMDS1, y=NMDS2, colour=factor(prob.clust.num)), 
             size=2,
...
ggsave(here("outputs_figures/clusters/prob_cluster_mar2022/div_hab/trait_nMDS_prob_clusters_div6_hab.png"), plot = trait_nMDS_prob_fig, width = 8, height = 8, dpi = 300)
