...
my_prey_adult = read.csv(here("data/prey_adults_traits.csv"), header=TRUE) %>%
...
#adult_traits = my_prey_adult[,2:ncol(my_prey_adult)]
## NOTES ----
...
#SAVE TREE
write.tree(my_tree_adult, here("data/albacore_diet_tree_adult"))
```
