...
write.csv(prey_length_data, here::here("data/output_data/alb_prey_raw_length_info.csv"), row.names = FALSE)
...
prey_length_wide = prey_length_data %>%
  dplyr::select(prey_class:life_stage, measure, length_tl) %>% #l_type_use, 
...
prey_length_ratios_max$larva_adult[is.na(prey_length_ratios_max$larva_adult)] <- NaN
prey_length_ratios_max$juve_adult[is.na(prey_length_ratios_max$juve_adult)] <- NaN

prey_length_ratios_max = prey_length_ratios %>%
  filter(measure == "l_max")

write.csv(prey_length_ratios_max, here::here("data/output_data/alb_prey_length_ratios_phyla.csv"), row.names = FALSE)
...
prey_length_ratiosp = prey_length_wide %>%
  ...
  left_join(prey_length_ratios_max, by = c("prey_family", "prey_order", "prey_class", "measure")) %>%
  ...
  dplyr::select(prey_class:l_larva, larva_adult:juve_adult, larva_adult_u:juve_adult_u, larva_adult_use:juve_adult_use) #%>%
