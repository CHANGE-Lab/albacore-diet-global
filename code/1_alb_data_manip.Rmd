...
alb_global = as.data.frame(read_xlsx(here::here("data/1_input_data/albacore_diet_global.xlsx"),
...
unique(alb_covars$StudyID) #26
unique(alb_covars$rep_ID) #70
...
write.csv(alb_global_prey_lengths, here::here("data/3_output_supp/alb_global_prey_lengths.csv"), row.names = FALSE)
...
write.csv(alb_global_prey_life, here::here("data/3_output_supp/alb_global_prey_life.csv"), row.names = FALSE)
...
write.csv(alb_global_metrics, here::here("data/3_output_supp/alb_global_metrics.csv"), row.names = FALSE)
...
write.csv(alb_global_metrics_basic, here::here("data/3_output_supp/alb_global_metrics_basic.csv"), row.names = FALSE)
