...
check_traits_vert = df_vert %>%
  dplyr::slice(which(df_vert$adult == df_vert$juvenile))
#136 with same
...
check_traits_diel = df_diel %>%
  dplyr::slice(which(df_diel$adult == df_diel$juvenile))
#136 with same
...
There were 136 species for which trait information did not differ between adult and juvenile life stages.
...
There were 85 species for which trait information differed in one or more traits for adult and juvenile life stages.
