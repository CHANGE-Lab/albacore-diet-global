...
write.csv(prey_morph_sum, here::here("data/output_data/prey_morph_sum.csv"))
...
write.csv(prey_qual_sum, here::here("data/output_data/prey_qual_sum.csv"))
...
write.csv(prey_trait_select, here::here("data/output_data/prey_trait_select.csv"))
...
write.csv(prey_trait_adult, here::here("data/output_data/prey_trait_adult.csv"))
...
Here we clean the levels of 'l_type' (length measurement type) factor as follows:
...
write.csv(prey_length_wide, here::here("data/output_data/prey_length_wide.csv"))
```
...
write.csv(prey_length_ratiosp, here::here("data/output_data/prey_length_ratiosp.csv"))
