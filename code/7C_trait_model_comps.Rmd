...
ocean_spp
#ocean_spp_sum = summary(ocean_spp, nBoot=10)
...
```{r Anova ocean_spp}
an_ocean_spp = anova(ocean_spp, nBoot = 10, test = "LR") #wald
...
#an_ocean_clusters_many = anova.traitglm(ocean_clusters_many, nBoot = 10, test = "wald")
...
#an_ocean_trait_many = anova.traitglm(ocean_trait_many, nBoot = 10, test = "wald")
...
an_ocean_full_many = anova.traitglm(ocean_full_many, nBoot = 10, test = "LR") #wald
...
#an_ocean_full_spp_many = anova.traitglm(ocean_full_spp_many, nBoot = 10, test = "wald")
