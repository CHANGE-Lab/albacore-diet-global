...
anova_comp1 = anova.traitglm(ocean_full_spp_many
                             , ocean_full_many
                             , ocean_trait_many
                             , ocean_clusters_many
                             , nBoot = 10
...
```{r ANOVA table output for MS 2, include =FALSE, eval=FALSE}
...
```{r ANOVA table output for MS 3, include =FALSE, eval=FALSE}

anova_comp3 = anova(ocean_spp
                            , ocean_trait_many
                            , ocean_clusters_many
                            )
