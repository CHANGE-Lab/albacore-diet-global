...
traits_use = alb_trait_use[,c(5:8,10)] %>%
...
ocean_full_spp_many = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_spp_many.rds"))

#Anovas
an_ocean_spp = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_spp_anova.rds"))
ocean_clusters_many = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_clusters_many.rds"))
an_ocean_trait_many = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_trait_many_anova.rds"))
...
saveRDS(an_ocean_spp, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_spp_anova.rds"))
...
ocean_ocean_spp_sum = summary(ocean_spp, 
                              ...
                              show.time=TRUE)
ocean_ocean_spp_sum
saveRDS(ocean_ocean_spp_sum, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_spp_summary.rds"))
```
...
saveRDS(an_ocean_clusters_many, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_clusters_many_anova.rds"))

ocean_ocean_clusters_sum = summary(ocean_clusters_many, nBoot=10)
ocean_ocean_clusters_sum
saveRDS(ocean_ocean_clusters_sum, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_clusters_many_summary.rds"))
```
...
an_ocean_trait_many = anova(ocean_trait_many, #test = "LR", 
                            nBoot = 10)
an_ocean_trait_many
saveRDS(an_ocean_trait_many, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_trait_many_anova.rds"))

ocean_ocean_trait_sum = summary(ocean_trait_many, nBoot=10)
ocean_ocean_trait_sum
saveRDS(ocean_ocean_trait_sum, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_trait_many_summary.rds"))
```
...
```{r Save key models, eval=FALSE}
#Manyglm
ocean_spp_LASSO = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_spp.rds"))
ocean_clusters_LASSO = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_clusters_many.rds"))
ocean_trait_LASSO = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_trait_many.rds"))
#saveRDS(ocean_full_spp_many, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_spp_many.rds"))
```
...
#saveRDS(ocean_spp_LASSO, here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_spp_LASSO.rds"))
#note default is "manyglm"
#note that col.intercepts = TRUE is the default
...
a        = max( abs(ocean_spp_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(ocean_spp_LASSO$fourth.corner))
...
ocean_spp_LASSO_graph = levelplot(temp, 
                     xlab=list("", cex=1.5), #Ocean Basins
                     ylab=list("Trait Guilds", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(ocean_spp_LASSO_graph)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_phylo_LASSO_graph.jpeg"), 
       plot = as.ggplot(ocean_phylo_LASSO_graph), width=8, height=12, dpi=300)
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_phylo_LASSO_graph.pdf"), 
       plot = as.ggplot(ocean_phylo_LASSO_graph), width=8, height=12, dpi=300)
...
#saveRDS(ocean_cluster_LASSO, here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_cluster_LASSO.rds"))
#note default is "manyglm"
#note that col.intercepts = TRUE is the default
...
#saveRDS(ocean_trait_LASSO, here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_trait_LASSO.rds"))
#note default is "manyglm"
#note that col.intercepts = TRUE is the default
...
```{r Save key models, eval=FALSE}
#Manyglm
saveRDS(ocean_spp_LASSO, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_spp.rds"))
saveRDS(ocean_clusters_LASSO, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_clusters_many.rds"))
saveRDS(ocean_trait_LASSO, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_trait_many.rds"))
#saveRDS(ocean_full_spp_many, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_spp_many.rds"))
```
