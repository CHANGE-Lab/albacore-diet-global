...
#ocean_spp$deviance
an_ocean_spp = anova(ocean_spp, test = "LR", nBoot = 10)
an_ocean_spp
...
#ocean_ocean_spp_sum = summary(ocean_spp, nBoot=10)
#ocean_ocean_spp_sum
...
an_ocean_trait_many = anova(ocean_trait_many, test = "LR", nBoot = 10)
an_ocean_trait_many
