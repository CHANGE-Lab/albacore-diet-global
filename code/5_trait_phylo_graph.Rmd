...
pal_prob_class2 = c("#003333", #Actinopterygii
                    #'#751308', #Branchiopoda #older teal colour "#66C2A5" #Not in prob data just was used for adult data
                    '#FF9900', #Cephalopoda
                    "#E86103", #Gastropoda #old orange '#F05E23'
                    "#990000", #Hexanauplia
                    "#663300", #Hydrozoa #'#013220'
                    '#CC0000', #Malacostraca '
                    "#006666",  #Thaliacea
...
prob_class <- ggtree(my_tree_prob_class, aes(color = group), layout = 'circular') +
  ...
  scale_colour_manual('Class', aesthetics = c('colour'), values = pal_prob_class2,
...
prob_class_lab <- ggtree(my_tree_prob_class, aes(color = group), layout = 'circular') +
   theme(legend.position = c(0.5,0.50),
        legend.title = element_text(size = 18), 
        legend.text = element_text(size = 18))+
  scale_colour_manual('Class', aesthetics = c('colour', 'fill'), values = pal_prob_class2,
                      breaks = c("Actinopterygii", "Cephalopoda","Gastropoda", "Hexanauplia", "Hydrozoa", "Malacostraca","Thaliacea"),
                      labels = c("Actinopterygii", "Cephalopoda","Gastropoda", "Hexanauplia", "Hydrozoa", "Malacostraca","Thaliacea")) +
  geom_tiplab(size = 2)
...
```{r Figure for class and habitat use traits - working}

# Create the colored phylogenetic tree
habitat_class_traits0 <- ggtree(my_tree_prob_class, aes(color = group), layout = 'circular') +
  #geom_tiplab(size = 5) +  # Increase the line width of the tree tips
...
#Add coloured heatmap for class as well
habitat_class_traits0.5 <- gheatmap(habitat_class_traits0, my_prey_prob[, 'prey_class', drop = FALSE], 
                                  offset = 0, width = 0.05, colnames = FALSE) +
  scale_fill_manual('Class', 
                      values = pal_prob_class2,
                      breaks = c("Actinopterygii", "Cephalopoda", "Gastropoda", "Hexanauplia", "Hydrozoa", "Malacostraca", "Thaliacea"),
                      labels = c("Actinopterygii", "Cephalopoda", "Gastropoda", "Hexanauplia", "Hydrozoa", "Malacostraca", "Thaliacea"),
                      na.translate = TRUE,
                      na.value = 'grey') +
  ...
  annotate('text', x = 1.05, y = -7.4, label = 'CLASS', angle = -85, size = 4) +
  new_scale_fill()

#habitat_class_traits0.5

# Create the first heatmap ring
habitat_class_traits1 <- gheatmap(habitat_class_traits0.5, my_prey_prob[, 'vert_habitat', drop = FALSE], 
                                  offset = 0.05, width = 0.05, colnames = FALSE) +
  ...
  theme(legend.position = c(1.1, 0.5),
        ...
        legend.text = element_text(size = 18)) +
  scale_y_continuous(expand = c(0, 4)) +
  annotate('text', x = 1.10, y = -7.4, label = 'VH', angle = -85, size = 4) +
  new_scale_fill()

# Create the second heatmap ring
habitat_class_traits2 <- gheatmap(habitat_class_traits1, my_prey_prob[, 'horz_habitat', drop = FALSE], 
  ...
  theme(legend.position = c(1.1, 0.5),
        ...
        legend.text = element_text(size = 18)) +
  scale_y_continuous(expand = c(0, 4)) +
  annotate('text', x = 1.15, y = -7.4, label = 'HH', angle = -85, size = 4) +
  new_scale_fill()

# Create the third heatmap ring
habitat_class_traits3 <- gheatmap(habitat_class_traits2, my_prey_prob[, 'diel_migrant', drop = FALSE], 
                                  offset = 0.15, width = 0.05, colnames = FALSE) +
  ...
  theme(legend.position = c(1.1, 0.5),
        ...
        legend.text = element_text(size = 18)) +
  scale_y_continuous(expand = c(0, 4)) +
  annotate('text', x = 1.20, y = -7.4, label = 'DM', angle = -85, size = 4) +
  new_scale_fill()

# Create the final heatmap ring
habitat_class_traits_final <- gheatmap(habitat_class_traits3, my_prey_prob[, 'season_migrant', drop = FALSE], 
                                       offset = 0.20, width = 0.05, colnames = FALSE) +
  ...
  theme(legend.position = c(1.1, 0.5),
        ...
        legend.text = element_text(size = 18)) +
  scale_y_continuous(expand = c(0, 4)) +
  annotate('text', x = 1.25, y = -7.4, label = 'SM', angle = -85, size = 4) +
  new_scale_fill()

# Check graph
habitat_class_traits_final

```

```{r Cool code with points instead of colour tree}
# Create the phylogenetic tree
phylo_tree <- ggtree(my_tree_prob_class, aes(color = group), layout = 'circular') +
  #geom_tiplab(size = 5) +  # Increase the line width of the tree tips
  theme(legend.position = c(1.1, 0.5),
        legend.title = element_text(size = 18),
        legend.text = element_text(size = 18)) +
...
# Create the first heatmap ring with legend to the left
habitat_class_traits0 <- phylo_tree +
  geom_tippoint(aes(color = group), size = 4) +
  theme(legend.position = c(0.1, 0.5),
        legend.title = element_text(size = 18),
        legend.text = element_text(size = 18)) +
  scale_color_manual("Class", values = pal_prob_class2,
                     breaks = c("Actinopterygii", "Cephalopoda", "Gastropoda", "Hexanauplia", "Hydrozoa", "Malacostraca", "Thaliacea"),
                     labels = c("Actinopterygii", "Cephalopoda", "Gastropoda", "Hexanauplia", "Hydrozoa", "Malacostraca", "Thaliacea"))

# Create the second heatmap ring with legend to the right
habitat_class_traits1 <- gheatmap(habitat_class_traits0, my_prey_prob[, 'vert_habitat', drop = FALSE], 
                                  offset = 0, width = 0.05, colnames = FALSE) +
  scale_fill_viridis_d(name = "Vertical Habitat (VH)",
                       direction = -1,
                       breaks = c("benthic", "demersal", "epipelagic", "mesopelagic", "bathypelagic"),
...
# Create the third heatmap ring
habitat_class_traits3 <- gheatmap(habitat_class_traits2, my_prey_prob[, 'diel_migrant', drop = FALSE], 
                                  offset = 0.10, width = 0.05, colnames = FALSE) +
  scale_fill_manual(name = "Diel Migrant (DM)",
                    breaks = c("0", "1"),
                    limits = c("0", "1"),
                    labels = c("no", "yes"),
...
# Create the final heatmap ring
habitat_class_traits_dot <- gheatmap(habitat_class_traits3, my_prey_prob[, 'season_migrant', drop = FALSE], 
                                       offset = 0.15, width = 0.05, colnames = FALSE) +
  scale_fill_manual(name = "Seasonal Migrant (SM)",
                    breaks = c("0", "1"),
                    limits = c("0", "1"),
...
# Check graph
habitat_class_traits_dot
```

```{r Cool code with points instead of colour tree and summary stats}
# Create the phylogenetic tree
phylo_tree <- ggtree(my_tree_prob_class, aes(color = group), layout = 'circular') +
  #geom_tiplab(size = 5) +  # Increase the line width of the tree tips
  theme(legend.position = c(1.1, 0.5),
...
habitat_class_traits1 <- gheatmap(habitat_class_traits0, my_prey_prob[, 'vert_habitat', drop = FALSE], 
  ...
  scale_fill_viridis_d(name = "Vertical Habitat (VH)",
                       ...
                       breaks = c("benthic", "demersal", "epipelagic", "mesopelagic", "bathypelagic"),
                       limits = c("benthic", "demersal", "epipelagic", "mesopelagic", "bathypelagic"),
                       labels = c("benthic (0.7%)", "demersal (10.1%)", "epipelagic (49.3%)", "mesopelagic (37.6%)", "bathypelagic (2.3%)"),
                       na.translate = TRUE,
                       option = 'D',
                       na.value = 'grey') +
  theme(legend.position = c(1.1, 0.5),
...
habitat_class_traits2 <- gheatmap(habitat_class_traits1, my_prey_prob[, 'horz_habitat', drop = FALSE], 
  ...
  scale_fill_viridis_d(name = "Horizontal Habitat (HH)",
                       ...
                       breaks = c("reef-associated", "coastal", "continental shelf", "continental slope", "oceanic"),
                       limits = c("reef-associated", "coastal", "continental shelf", "continental slope", "oceanic"),
                       labels = c("reef-associated (2.3%)", "coastal (12.1%)", "continental shelf (24.8%)", 
                                  "continental slope (6.5%)", "oceanic (54.3%)"),
                       na.translate = TRUE,
                       option = 'D',
                       na.value = 'grey') +
  theme(legend.position = c(1.1, 0.5),
...
# Create the final heatmap ring
habitat_class_traits_dot_v2 <- gheatmap(habitat_class_traits3, my_prey_prob[, 'season_migrant', drop = FALSE], 
                                       offset = 0.15, width = 0.05, colnames = FALSE) +
  scale_fill_manual(name = "Seasonal Migrant (SM)",
                    breaks = c("0", "1"),
                    limits = c("0", "1"),
                    labels = c("no (31%)", "yes (69%)"),
                    values = c("0" = "#FDE725FF", "1" = "#39568CFF"), 
                    na.value = 'grey') +
  theme(legend.position = c(1.1, 0.5),
        legend.title = element_text(size = 18), 
...
## Summary stats to add to phylo graph

```{r calculate summary stats for traits}

stat_vert = as.data.frame(table(my_prey_prob$vert_habitat)) %>%
  mutate(percent_vert = Freq*100/sum(Freq))
stat_vert
sum(stat_vert$Freq)
sum(stat_vert$percent_vert)
#bathypelagic      benthic     demersal   epipelagic  mesopelagic 
#           7            2           31          151          115 

stat_horz = as.data.frame(table(my_prey_prob$horz_habitat)) %>%
  mutate(percent_horz = Freq*100/sum(Freq))
stat_horz

stat_diel = as.data.frame(table(my_prey_prob$diel_migrant)) %>%
  mutate(percent_diel = Freq*100/sum(Freq))
stat_diel

stat_season = as.data.frame(table(my_prey_prob$season_migrant)) %>%
  mutate(percent_season = Freq*100/sum(Freq))
stat_season
```
...
ggsave("prob_basic.png",
  #here::here("./outputs_figures/2_phylo_graphs/prey_prob/prob_basic.png"),
  plot=prob_basic, width=8, height=8, dpi=300)

ggsave("prob_basic_lab.png",
       #here::here("./outputs_figures/2_phylo_graphs/prey_prob/prob_basic_lab.png"),
...
ggsave("prob_class.png",
  #here::here('./outputs_figures/2_phylo_graphs/prob_class.png'), 
  plot=prob_class, width=13, height=10, dpi=300)

ggsave("prob_class_lab.png",
  #here::here('./outputs_figures/2_phylo_graphs/prob_class_lab.png'), 
...
ggsave(#"prob_hab1.png",
       here::here("./output_figures/2_phylo_graphs/prey_prob/prob_hab1.png"),
...
#Save habitat class traits
ggsave("habitat_class_traits_final.png",
       #here::here('./output_figures/2_phylo_graphs/habitat_class_traits_final.png'), 
       plot=habitat_class_traits_final, width=14, height=10, dpi=300)

#Save habitat class traits
ggsave("habitat_class_traits_dot.png",
       #here::here('./output_figures/2_phylo_graphs/habitat_class_traits_final.png'), 
       plot=habitat_class_traits_dot, width=15, height=10, dpi=300)

#Save habitat class traits
ggsave("habitat_class_traits_dot_stats.png",
       #here::here('./output_figures/2_phylo_graphs/habitat_class_traits_final.png'), 
       plot=habitat_class_traits_dot_v2, width=16, height=15, dpi=300)
```
