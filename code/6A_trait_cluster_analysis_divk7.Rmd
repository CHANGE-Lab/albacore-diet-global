...
write.csv(prob.stats.df.divisive, here("outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.stats.df.divisive.hab.csv"))
...
prob.div.elbow
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.div.elbow.hab.png'), 
...
prob.div.silh = ggplot(data = data.frame(t(cstats.table(prob.gower.dist, prob.divisive.clust, 20))), 
  ...
  theme(plot.title = element_text(hjust = 0.5))
prob.div.silh
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.div.silh.hab.png'), 
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/k7/prob.dendro.heatcounts.divis.k7.life.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/k7/prob.dendro.heatpercent.divis.k7.life.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
...
trait_NMDS_prob <- metaMDS(prob.gower.dist, trymax = 1000) #solution after 20 iterations
...
fig3.pal <- c("#00496F", "#EDD746", "#0A718F", "#59A082", 
...
ggsave(here("outputs_figures/clusters/prob_cluster_mar2022/div_hab/trait_nMDS_prob_clusters_div7_hab.png"), plot = trait_nMDS_prob_fig, width = 8, height = 8, dpi = 300)
