...
prey_traits_load = read.csv(here::here("data/output_data/prey_trait_select.csv"), header=TRUE) %>%   dplyr::select(-c(diel_migrant, refuge_cat, season_migrant, life_note, diet_likely)) %>% 
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/k7/prob.dendro.heatcounts.divis.k7.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/div_hab/k7/prob.dendro.heatpercent.divis.k7.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
