...
alb_global_diet = alb_global %>%
  ...
  dplyr::select(StudyID, CiteAuth, YearEnd, rep_ID, OceanBasin:MonthRange, province, code, lat_cat, pred_life_adjust, stomachs_used:est_ref, prey_class:maxl_type, gape_lmax, gape_height_limit) #system, CiteYear, 
...
write.csv(alb_global_dietpa, here("data/2_output_data/alb_global_wide_dietpa.csv"), 
          row.names = FALSE)
```
...
write.csv(alb_global_dietfo, here("data/2_output_data/alb_global_wide_dietfo.csv"), 
          row.names = FALSE)
...
write.csv(alb_global_dietn, here("data/2_output_data/alb_global_wide_dietn.csv"), row.names = FALSE)
```
...
write.csv(alb_global_dietm, here("data/2_output_data/alb_global_wide_dietm.csv"), row.names = FALSE)
