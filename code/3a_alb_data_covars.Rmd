...
write.csv(alb_global_diet, here::here("data/output_data/alb_global_diet_total_v2.csv"), 
          row.names = FALSE)
```
...
alb_covars_esti_SI = alb_global_diet %>%
  ...
  #       )
#Write over previous output from first data chunk
write.csv(alb_covars_esti_SI, here::here("data/output_data/alb_covars_estimates.csv"), 
          row.names = FALSE)
