...
summary(alb_prob_traits$prey_order_test)

#Need to merge Gastropoda, Hexanauplia and Hydrozoa due to low occurrence of those taxa
alb_prob_traits$prey_order_test=as.character(alb_prob_traits$prey_order_test)

alb_prob_traits$prey_order_test[alb_prob_traits$prey_order_test=="Gastropoda"] <- "Pelagic Invertebrate"
alb_prob_traits$prey_order_test[alb_prob_traits$prey_order_test=="Hexanauplia"] <- "Pelagic Invertebrate"
alb_prob_traits$prey_order_test[alb_prob_traits$prey_order_test=="Hydrozoa"] <- "Pelagic Invertebrate"

alb_prob_traits$prey_order_test=as.factor(alb_prob_traits$prey_order_test)
summary(alb_prob_traits$prey_order_test)
...
traits_use = alb_prob_traits[,c(4:10,12)] %>%
...
- prob_life_phylo_many (redone)

- prob_ocean_phylo_many (redone)
...
**MANYGLM Phylo - Predator Life Stage**

Trait (phylo)*Env (life stage) - Manyglm

```{r Phylo life stage manyglm}

prob_life_phylo_many <- traitglm(L = alb_prob_preyPA_mv,
                                    R = alb_prob_covars$pred_life_adjust,
                                    Q = traits_use$prey_order_test,
                                    family=binomial(link = "logit")
                                    ) #note default is "manyglm"
...
```{r Plot phylo life manyglm, tidy=TRUE, message=FALSE, warning=FALSE}

a        = max( abs(prob_life_phylo_many$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(prob_life_phylo_many$fourth.corner))

rownames(temp) = c("Adult", "Juvenile")

prob_life_phylo_many_graph = levelplot(temp, 
                     xlab=list("Predator Life Stage", cex=1.5),
...
print(prob_life_phylo_many_graph)

ggsave(here("./outputs_figures/traitglms/prob_models_sep2021/prob_life_phylo_many_graph.pdf"), 
       plot = as.ggplot(prob_life_phylo_many_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_life_phylo_many_graph.jpeg"), 
       plot = as.ggplot(prob_life_phylo_many_graph), width=12, height=12, dpi=300)

```

**GLM1PATH Phylo - Predator Life Stage**

Using method = glm1path == LASSO model.

```{r Phylo life  LASSO}

prob_life_phylo_LASSO <- traitglm(L = alb_prob_preyPA_mv,
                                    R = alb_prob_covars$pred_life_adjust,
                                    Q = traits_use$prey_order_test,
                                    family=binomial(link = "logit"),
                                    method="glm1path"
...
```{r Plot phylo life LASSO, tidy=TRUE, message=FALSE, warning=FALSE}

a        = max( abs(prob_life_phylo_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(prob_life_phylo_LASSO$fourth.corner))

rownames(temp) = c("Mixed", "Adult", "Juvenile")

prob_life_phylo_LASSO_graph = levelplot(temp,
                                          xlab=list("Predator Life Stage", cex=1.5),
                                          ylab=list("Species phylogeny", cex=1.5),
                                          col.regions=colort(100),
                                          at=seq(-a, a,length=100),
...
print(prob_life_phylo_LASSO_graph)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_life_phylo_LASSO_graph.pdf"), 
       plot = as.ggplot(prob_life_phylo_LASSO_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_life_phylo_LASSO_graph.jpeg"), 
       plot = as.ggplot(prob_life_phylo_LASSO_graph), width=12, height=12, dpi=300)
...
prob_ocean_phylo_many <- traitglm(L = alb_prob_preyPA_mv,
                                     R = alb_prob_covars$OceanBasinUse,
                                     Q = traits_use$prey_order_test,
                                     family=binomial(link = "logit")
                                     ) #note default is "manyglm"
...
a        = max( abs(prob_ocean_phylo_many$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(prob_ocean_phylo_many$fourth.corner))
...
prob_ocean_phylo_many_graph = levelplot(temp, 
                     xlab=list("Ocean Basins", cex=1.5),
                     ylab=list("Species phylogeny", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(prob_ocean_phylo_many_graph)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_ocean_phylo_many_graph.pdf"), 
       plot = as.ggplot(prob_ocean_phylo_many_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_ocean_phylo_many_graph.jpeg"), 
       plot = as.ggplot(prob_ocean_phylo_many_graph), width=12, height=12, dpi=300)
...
prob_ocean_phylo_LASSO <- traitglm(L = alb_prob_preyPA_mv,
                                     R = alb_prob_covars$OceanBasinUse,
                                     Q = traits_use$prey_order_test,
                                     family=binomial(link = "logit"),
                                     method="glm1path"
...
a        = max( abs(prob_ocean_phylo_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(prob_ocean_phylo_LASSO$fourth.corner))
...
prob_ocean_phylo_LASSO_graph = levelplot(temp, 
                     xlab=list("Ocean Basins", cex=1.5),
                     ylab=list("Species phylogeny", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(prob_ocean_phylo_LASSO_graph)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_ocean_phylo_LASSO_graph.pdf"), 
       plot = as.ggplot(prob_ocean_phylo_LASSO_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_ocean_phylo_LASSO_graph.jpeg"), 
       plot = as.ggplot(prob_ocean_phylo_LASSO_graph), width=12, height=12, dpi=300)
...
**MANYGLM Phylo - Climate**

Trait (phylo)*Env (climate) - Manyglm

```{r Phylo latitude manyglm}

prob_lat_phylo_many <- traitglm(L = alb_prob_preyPA_mv,
                                     R = alb_prob_covars$lat_cat,
                                     Q = traits_use$prey_order_test,
                                     family=binomial(link = "logit")
                                     ) #note default is "manyglm"
...
```{r Plot phylo latitude manyglm, tidy=TRUE, message=FALSE, warning=FALSE}

a        = max( abs(prob_lat_phylo_many$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(prob_lat_phylo_many$fourth.corner))

rownames(temp) = c("Tropical")

prob_lat_phylo_many_graph = levelplot(temp, 
                     xlab=list("Climate", cex=1.5),
                     ylab=list("Species phylogeny", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(prob_lat_phylo_many_graph)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_lat_phylo_many_graph.pdf"), 
       plot = as.ggplot(prob_lat_phylo_many_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_lat_phylo_many_graph.jpeg"), 
       plot = as.ggplot(prob_lat_phylo_many_graph), width=12, height=12, dpi=300)

```

**GLM1PATH Phylo - Climate**

Using method = glm1path == LASSO model.

```{r Phylo latitude LASSO}

prob_lat_phylo_LASSO <- traitglm(L = alb_prob_preyPA_mv,
                                     R = alb_prob_covars$lat_cat,
                                     Q = traits_use$prey_order_test,
                                     family=binomial(link = "logit"),
                                     method="glm1path"
...
```{r Plot phylo latitude LASSO, tidy=TRUE, message=FALSE, warning=FALSE}

a        = max( abs(prob_lat_phylo_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(prob_lat_phylo_LASSO$fourth.corner))

rownames(temp) = c("Tropical")

prob_lat_phylo_LASSO_graph = levelplot(temp, 
                     xlab=list("Climate", cex=1.5),
                     ylab=list("Species phylogeny", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(prob_lat_phylo_LASSO_graph)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_lat_phylo_LASSO_graph.pdf"), 
       plot = as.ggplot(prob_lat_phylo_LASSO_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_models_sep2021/prob_lat_phylo_LASSO_graph.jpeg"), 
       plot = as.ggplot(prob_lat_phylo_LASSO_graph), width=12, height=12, dpi=300)
...
#Manyglms
saveRDS(prob_life_phylo_many, 
        file = here("outputs_figures/traitglms/prob_models_sep2021/prob_life_phylo_many.rds")) 
saveRDS(prob_ocean_phylo_many, 
        file = here("outputs_figures/traitglms/prob_models_sep2021/prob_ocean_phylo_many.rds"))
saveRDS(prob_lat_phylo_many, 
        file = here("outputs_figures/traitglms/prob_models_sep2021/prob_lat_phylo_many.rds"))

#LASSO glms
saveRDS(prob_life_phylo_LASSO, 
        file = here("outputs_figures/traitglms/prob_models_sep2021/prob_life_phylo_LASSO.rds"))
saveRDS(prob_ocean_phylo_LASSO, 
        file = here("outputs_figures/traitglms/prob_models_sep2021/prob_ocean_phylo_LASSO.rds"))
saveRDS(prob_lat_phylo_LASSO, 
        file = here("outputs_figures/traitglms/prob_models_sep2021/prob_lat_phylo_LASSO.rds"))
