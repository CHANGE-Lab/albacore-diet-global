...
write.csv(prob.stats.df.divisive, here("outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.stats.df.divisive.csv"))
...
prob.div.elbow
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.div.elbow.png'), 
...
prob.div.silh = ggplot(data = data.frame(t(cstats.table(prob.gower.dist, prob.divisive.clust, 20))), 
  ...
  theme(plot.title = element_text(hjust = 0.5))
prob.div.silh
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.div.silh.png'), 
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.dendro.horz.k6.png'), plot=prob.dendro.graph, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.dendro.rad.k6.png'), plot=prob.dendro.rad, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.dendro.vertlabs.k6.pdf'), plot=ggd1, width=5, height=20, dpi=300)
...
prob.dendro.vert 
#Export as .png
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.dendro.vert2.k6.png'), plot=prob.dendro.vert, width=5, height=12, dpi=300)
...
write.csv(prob.prey.cl, here("outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.prey.clusternum.divis.k6.csv"))
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.dendro.heatcounts.divis.k6.life.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022/divisivek6/prob.dendro.heatpercent.divis.k6.life.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
...
ggsave(here("outputs_figures/clusters/prob_cluster_mar2022/divisivek6/trait_nMDS_prob_clusters_div6.png"), 
