...
nrow(my_prey_prob) #298 #now 306
length(my_tree_prob$tip.label) #298 #now 306
...
x2[1,1] = y2[4]; #--> Diplodus sargus
x2[2,1] = y2[1]; #--> Leuroglossus stilbius
x2[3,1] = y2[2]; #--> Liocranchia reinhardtii
x2[4,1] = y2[3]; #--> Mullus barbatus barbatus
x2[5,1] = y2[5]; #--> Notoscopelus kroyeri
x2[6,1] = y2[6]; #--> Robustosergia robusta
...
habitat_traits_prob_agg_final <- gheatmap(habitat_traits_prob4.5, 
  ...
  scale_fill_viridis_d(name = "Gregariousness (GG)", 
                       ...
                       na.value = 'grey')+
  scale_y_continuous(expand = c(0,4))+
  annotate('text', x = 1.23, y = -7.5, label = 'SM', angle = -85, size = 4)
...
ggsave("prob_basic.png",
  #here("../output_figures/phylo_graphs/prey_prob/prob_basic.png"), 
...
```{r Save Figures - behaviour, include = FALSE, eval=FALSE}
...
```{r Save Figures - morphology / shape, include = FALSE, eval=FALSE}
...
```{r Save Figures - morphology / defense, include = FALSE, eval=FALSE}

#Save graph 1
ggsave("prob_morph_bin1.png",
  #here('./output_figures/phylo_graphs/prob_morph_bin1.png'),
  plot=morphology_binary_prob1, width=12, height=10, dpi=300)

#Save graph 2
ggsave("prob_morph_bin2.png",
       #here('./output_figures/diet_phylo/prey_prob/prob_morph_bin2.png'), 
       plot=morphology_binary_prob2, width=12, height=10, dpi=300)

#Save graph 3
ggsave("prob_morph_bin3.png",
       #here('./output_figures/diet_phylo/prey_prob/prob_morph_bin3.png'), 
       plot=morphology_binary_prob3, width=12, height=10, dpi=300)

#Save graph 4
ggsave("prob_morph_bin4.png",
       #here('./output_figures/diet_phylo/prey_prob/prob_morph_bin4.png'), 
       plot=morphology_binary_prob4, width=12, height=10, dpi=300)
#Save graph 5
ggsave("prob_morph_bin5.png",
       #here('./output_figures/diet_phylo/prey_prob/prob_morph_bin5.png'), 
       plot=morphology_binary_prob_final, width=12, height=10, dpi=300)

```

**Phylogeny by nutritional quality**

```{r Save Figures - nutritional quality, include = FALSE, eval=FALSE}

#Save graph 1
ggsave("prob_nutri_ed.png",
       #here('./output_figures/diet_phylo/prey_prob/prob_nutri_ed.png'), 
       plot=nutritional_quality_prob1, width=12, height=10, dpi=300)

#Save graph 2
ggsave("prob_nutri_protein.png",
  #here('./output_figures/diet_phylo/prey_prob/prob_nutri_protein.png'), 
  plot=nutritional_quality_prob2, width=12, height=10, dpi=300)

#Save graph 3
ggsave("prob_nutri_lipid.png",
  #here('./output_figures/diet_phylo/prey_prob/prob_nutri_lipid.png'), 
  plot=nutritional_quality_prob_final, width=12, height=10, dpi=300)

```

**Phylogeny by fisheries status**

```{r Save Figures - fisheries status, include = FALSE, eval=FALSE}

#Save graph
ggsave("prob_fishery.png",
  #here('./output_figures/diet_phylo/prey_prob/prob_fishery.png'), 
  plot=fishery_prob, width=12, height=10, dpi=300)
