...
- Species (L): alb_prey_fo_use ==> "./data/output_data/alb_prey_fo_use.csv"

- Env/Site (R): alb_covars_use ==> "./data/output_data/alb_covars_use.csv"

- Traits (Q): alb_trait_fo_use ==> "./data/output_data/alb_trait_fo_use.csv"
...
#L - species df
alb_prey_fo_use = read.csv(here::here("./data/output_data/alb_prey_fo_use.csv"))
dim(alb_prey_fo_use)
```
...
#R - covars df
alb_covars_use = read.csv(here::here("./data/output_data/alb_covars_use.csv"))
...
#Q - trait df
alb_trait_fo_use = read.csv(here::here("./data/output_data/alb_trait_fo_use.csv")) #%>%
#  select(-X)

#Needs species as rows
#Assign speces as rownames
rownames(alb_trait_fo_use) <- alb_trait_fo_use$prey_sp
#Order species list if needed
alb_trait_fo_use <- alb_trait_fo_use[ order(row.names(alb_trait_fo_use)), ]
#Traits as factors for analyses
alb_trait_fo_use[,1:ncol(alb_trait_fo_use)] =  lapply(alb_trait_fo_use[,1:ncol(alb_trait_fo_use)], as.factor)

dim(alb_trait_fo_use)
...
summary(alb_trait_fo_use$life_stage) #DON'T USE

summary(alb_trait_fo_use$vert_habitat) #USE

summary(alb_trait_fo_use$horz_habitat) #USE

summary(alb_trait_fo_use$diel_migrant_cat) #USE

summary(alb_trait_fo_use$season_cat) #USE

summary(alb_trait_fo_use$gregarious) #DON'T USE

summary(alb_trait_fo_use$prob.clust.num) #USE
...
summary(alb_trait_fo_use$prey_order) #do not use yet

#Need to merge Gastropoda, Hexanauplia and Hydrozoa due to low occurrence of those taxa
#alb_trait_fo_use$prey_order_test=as.character(alb_trait_fo_use$prey_order_test)
#alb_trait_fo_use$prey_order_test[alb_trait_fo_use$prey_order_test=="Gastropoda"] <- "Pelagic Invertebrate"
#alb_trait_fo_use$prey_order_test[alb_trait_fo_use$prey_order_test=="Hexanauplia"] <- "Pelagic Invertebrate"
#alb_trait_fo_use$prey_order_test[alb_trait_fo_use$prey_order_test=="Hydrozoa"] <- "Pelagic Invertebrate"
#alb_trait_fo_use$prey_order_test=as.factor(alb_trait_fo_use$prey_order_test)
#summary(alb_trait_fo_use$prey_order_test)
...
levels(alb_trait_fo_use$vert_habitat) #check

levels(alb_trait_fo_use$horz_habitat) #check

#levels(alb_trait_fo_use$gregarious) #check
...
rownames(alb_trait_fo_use) == colnames(alb_prey_fo_use) #awesome!

alb_prey_fo_use_prop = alb_prey_fo_use/100

# Then create the mvabund matrix
alb_prey_fo_use_mv = as.mvabund(alb_prey_fo_use_prop)

#Check again that species names match trait values
rownames(alb_trait_fo_use) == colnames(alb_prey_fo_use_mv) #awesome!

#Check all matrix dimensions
dim(alb_trait_fo_use) #good
dim(alb_prey_fo_use_mv) #good
...
traits_use = alb_trait_fo_use[,c(4:9)] %>%
...
ocean_spp <- traitglm(L = alb_prey_fo_use_mv,
...
ocean_spp_LASSO <- traitglm(L = alb_prey_fo_use_mv,
                      R = alb_covars_use$OceanBasin,
                      family=binomial(link = "logit"),
                      method="glm1path"
                      ) #note default is "manyglm"
...
ocean_clusters_many <- traitglm(L = alb_prey_fo_use_mv,
                                     R = alb_covars_use$OceanBasin,
...
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_clusters_many_graph.pdf"), 
       plot = as.ggplot(ocean_clusters_many_graph), width=12, height=12, dpi=300)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_clusters_many_graph.jpeg"), 
       plot = as.ggplot(ocean_clusters_many_graph), width=12, height=12, dpi=300)
...
ocean_cluster_LASSO <- traitglm(L = alb_prey_fo_use_mv,
                                R = alb_covars_use$OceanBasin,
                                Q = traits_use$cluster,
                                family=binomial(link = "logit"),
                                method="glm1path"
...
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_cluster_LASSO_graph.pdf"), 
       plot = as.ggplot(ocean_cluster_LASSO_graph), width=8, height=8, dpi=300)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_cluster_LASSO_graph.jpeg"), 
       plot = as.ggplot(ocean_cluster_LASSO_graph), width=8, height=8, dpi=300)
...
ocean_cluster_LASSO$coefficients#[86:97]

#a        = max( abs(t_fullA$coefficients[86:97]) )
#second = t(as.matrix(t_fullA$coefficients[86:97]))
#View(second)
#rownames(second) = " "
...
ocean_phylo_many <- traitglm(L = alb_prey_fo_use_mv,
                                     R = alb_covars_use$OceanBasin,
                                     Q = alb_trait_fo_use$prey_order,
                                     family=binomial(link = "logit")
                                     ) #note default is "manyglm"
...
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_phylo_many_graph.pdf"), 
       plot = as.ggplot(ocean_phylo_many_graph), width=12, height=18, dpi=300)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_phylo_many_graph.jpeg"), 
       plot = as.ggplot(ocean_phylo_many_graph), width=12, height=18, dpi=300)
...
ocean_phylo_LASSO <- traitglm(L = alb_prey_fo_use_mv,
                              R = alb_covars_use$OceanBasin,
                              Q = alb_trait_fo_use$prey_order,
                              family=binomial(link = "logit"),
                              method="glm1path"
...
colnames(temp) = c("Amphipoda", "Aulopiformes", "Beloniformes", "Caenogastropoda",
                   "Calanoida",
                  "Clupeiformes", "Decapoda", "Decapodiformes", "Euphausiacea",
                  "Gadiformes", "Isopoda", "Littorinimorpha", "Lophogastrida",
                  "Myctophiformes", "Myopsida", "Octopoda", "Oegopsida",
                  "Osmeriformes", "Perciformes", "Pleuronectiformes",
                  "Pteropoda", "Salpida",
                  "Scorpaeniformes", "Sepiida", "Siphonophorae",
                  "Stephanoberyciformes", "Stomiiformes", "Sygnathiformes", "Syngnathiformes") 
#NOTE Sygnathiformes pb #"Sygnathiformes", removed

ocean_phylo_LASSO_graph = levelplot(temp, 
                     xlab=list("", cex=1.5), #Ocean Basins
                     ylab=list("Phylogenetic Order", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
                     scales = list(x=list(rot = 45, cex=1.3), y=list(cex=1.3)), 
                     colorkey=list(labels=list(cex=1.3)))
...
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_phylo_LASSO_graph.pdf"), 
       plot = as.ggplot(ocean_phylo_LASSO_graph), width=12, height=12, dpi=300)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_phylo_LASSO_graph.jpeg"), 
       plot = as.ggplot(ocean_phylo_LASSO_graph), width=12, height=12, dpi=300)
...
ocean_trait_many <- traitglm(L = alb_prey_fo_use_mv,
                             R = alb_covars_use$OceanBasin,
...
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_traits_many_graph.pdf"), 
       plot = as.ggplot(ocean_trait_many_graph), width=12, height=12, dpi=300)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_traits_many_graph.jpeg"), 
       plot = as.ggplot(ocean_trait_many_graph), width=12, height=12, dpi=300)
...
ocean_trait_LASSO <- traitglm(L = alb_prey_fo_use_mv,
                                 R = alb_covars_use$OceanBasin,
                                 Q = traits_use[,1:4], #traits_use[,1:5]
                                 family=binomial(link = "logit"),
                                 method="glm1path"
...
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_traits_LASSO_graph.pdf"), 
       plot = as.ggplot(ocean_LASSO_graph), width=12, height=8, dpi=300)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_traits_LASSO_graph.jpeg"), 
       plot = as.ggplot(ocean_LASSO_graph), width=12, height=8, dpi=300)
...
#Manyglm
saveRDS(ocean_spp, file = here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_spp.rds"))
saveRDS(ocean_clusters_many, file = here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_clusters_many.rds"))
saveRDS(ocean_phylo_many, file = here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_phylo_many.rds"))
saveRDS(ocean_trait_many, file = here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_trait_many.rds"))

#LASSO glms
saveRDS(ocean_spp_LASSO, file = here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_spp_LASSO.rds"))
saveRDS(ocean_cluster_LASSO, file = here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_cluster_LASSO.rds"))
saveRDS(ocean_phylo_LASSO, file = here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_phylo_LASSO.rds"))
saveRDS(ocean_trait_LASSO, file = here::here("outputs_figures/traitglms/ocean_models_2022_FO/ocean_trait_LASSO.rds"))
...
#PA
alb_pa_ord = metaMDS(alb_prey_fo_use,
                     distance="jaccard",
                     #trymax=20,
                     trymax = 1000,#10000, #1000
                     k=3) #could increase to k = 4

saveRDS(alb_pa_ord, here("outputs_figures/traitglms/alb_nMDS_pa.rds"))
...
data.scores <- as.data.frame(scores(alb_pa_ord))  #, "species"
...
hull.data.ocean <- rbind(`grp.N Atlantic`, `grp.Mediterranean`, `grp.N Pacific`, `grp.S Pacific`)  
...
ggsave(here("outputs_figures/traitglms/ocean_models_2022/nMDS_ocean.jpeg"), 
