...
unique(alb_adult_traits$prey_sp)
...
trait_life_clusters_many <- traitglm(L = alb_adult_preyPA_mv,
                      R =  pred_life,                       
                      Q = trait_clust,
                      family=binomial(link = "logit")
                      ) #note default is "manyglm"
...
#Check model output - residuals TEST
qqnorm(residuals(trait_life_clusters_many)[which(residuals(trait_life_clusters_many)<10000)]); abline(c(0,1),col="red")

#omit non-finite residuals FULL MODEL
resids.full = residuals(trait_life_clusters_many)[is.finite((residuals(trait_life_clusters_many)))]
...
a        = max( abs(trait_life_clusters_many$fourth.corner) )
colort   = colorRampPalette(c("blue","white","red")) 
temp = t(as.matrix(trait_life_clusters_many$fourth.corner))
...
trait_life_clusters_many = levelplot(temp, 
...
print(trait_life_clusters_many)

ggsave(here("outputs_figures/traitglms/trait_life_clusters_many.pdf"), plot = as.ggplot(trait_life_clusters_many), width=12, height=12, dpi=300)
...
trait_ocean_clusters_many <- traitglm(L = alb_adult_preyPA_mv,
                      R = ocean,                       
                      Q = trait_clust,
                      family=binomial(link = "logit")
                      ) #note default is "manyglm"
...
#Check model output - residuals TEST
qqnorm(residuals(trait_ocean_clusters_many)[which(residuals(trait_ocean_clusters_many)<10000)]); abline(c(0,1),col="red")

#omit non-finite residuals FULL MODEL
resids.full = residuals(trait_ocean_clusters_many)[is.finite((residuals(trait_ocean_clusters_many)))]
plot(resids.full); abline(c(0,0),col="red")
...
a        = max( abs(trait_ocean_clusters_many$fourth.corner) )
colort   = colorRampPalette(c("blue","white","red")) 
temp = t(as.matrix(trait_ocean_clusters_many$fourth.corner))
...
trait_ocean_clusters_4th_many = levelplot(temp, 
                     xlab=list("Ocean Basins", cex=1.5),
                     ylab=list("Species traits", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(trait_ocean_clusters_4th_many)

ggsave(here("outputs_figures/traitglms/trait_ocean_clusters_4th_many.pdf"), plot = as.ggplot(trait_ocean_clusters_4th_many), width=12, height=12, dpi=300)
...
trait_life_cluster_LASSO <- traitglm(L = alb_adult_preyPA_mv,
                      R = pred_life,                       
                      Q = trait_clust,
                      family=binomial(link = "logit"),
                      method="glm1path"
...
a        = max( abs(trait_life_cluster_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","white","red")) 
temp = t(as.matrix(trait_life_cluster_LASSO$fourth.corner))
...
trait_life_cluster_4th_LASSO = levelplot(temp, 
                     xlab=list("Life Stage", cex=1.5),
                     ylab=list("Species traits", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
                     scales = list(x=list(rot = 45, cex=1.3), y=list(cex=1.3)), 
...
print(trait_life_cluster_4th_LASSO)

#trait_ocean_4th = as.ggplot(trait_ocean_4th)

ggsave(here("outputs_figures/traitglms/trait_life_cluster_4th_LASSO.pdf"), 
       plot = as.ggplot(trait_life_cluster_4th_LASSO), width=12, height=12, dpi=300)
...
trait_ocean_cluster_LASSO <- traitglm(L = alb_adult_preyPA_mv,
                      R = ocean,                       
                      Q = trait_clust,
                      family=binomial(link = "logit"),
                      method="glm1path"
...
a        = max( abs(trait_ocean_cluster_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","white","red")) 
temp = t(as.matrix(trait_ocean_cluster_LASSO$fourth.corner))
...
trait_ocean_cluster_LASSO = levelplot(temp, 
...
print(trait_ocean_cluster_LASSO)

ggsave(here("outputs_figures/traitglms/trait_ocean_cluster_LASSO.pdf"), 
       plot = as.ggplot(trait_ocean_cluster_LASSO), width=12, height=12, dpi=300)
...
```{r TraitGLM - ocean many anova}

anova.traitglm(trait_ocean_binom_many)
...
```{r Predict traiglm - ocean}

predict_trait_ocean = predict.traitglm(trait_ocean_binom)

trait_ocean_binom$fourth.corner
