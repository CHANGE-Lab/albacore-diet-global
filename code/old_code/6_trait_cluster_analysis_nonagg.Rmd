...
write.csv(prob.stats.df.divisive, here("outputs_figures/clusters/prob_cluster_mar2022_nonagg/prob.stats.df.divisive.csv"))
...
write.csv(prob.stats.df.aggl, here("outputs_figures/clusters/prob_cluster_mar2022_nonagg/prob.stats.df.aggl.csv"))
...
```{r Cluster Selection - Agglomerative, eval=FALSE, warning=FALSE, message=FALSE}
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022_nonagg/prob.elbow.plot.k7.div.png'), width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022_nonagg/prob.sil.plot.k7.div.png'), width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022_nonagg/prob.dendro.horz.k7.png'), plot=prob.dendro.graph, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob_cluster_mar2022_nonagg/prob.dendro.rad.k7.png'), plot=prob.dendro.rad, width=8, height=8, dpi=300)
...
ggsave(here("outputs_figures/clusters/prob_cluster_sep2021_nonagg/trait_nMDS_prob_clusters.png"), 
