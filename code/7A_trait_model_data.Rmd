...
alb_prey_pa = read.csv(paste(here::here("data/output_data/alb_global_wide_dietpa.csv"),
...
dim(alb_prey_use) #63 rows and 129 spp
...
#L - species df
write.csv(alb_prey_use, here::here("./data/output_data/alb_prey_pa_use.csv"), row.names=FALSE)

#R - covars df
write.csv(alb_covars, here::here("./data/output_data/alb_covars_use.csv"), row.names=FALSE)

#Q - trait df
write.csv(alb_trait_use, here::here("./data/output_data/alb_trait_use.csv"), row.names=FALSE)
