...
length(which(colSums(alb_prey_pa[,10:ncol(alb_prey_pa)])<2)) #173 species have low prevalence
...
alb_prey_use = alb_prey_pa[colnames(alb_prey_pa) %notin% names(which(colSums(alb_prey_pa[,10:ncol(alb_prey_pa)])<1))]
