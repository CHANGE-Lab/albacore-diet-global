...
#Full models
ocean_full_many = readRDS(file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_many.rds"))
ocean_full_LASSO = readRDS(file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_LASSO.rds"))

ocean_full_spp_many = readRDS(file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_spp_many.rds"))
ocean_full_spp_LASSO = readRDS(file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_spp_LASSO.rds"))
...
#saveRDS(ocean_spp_sum, here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_spp_sum.rds"))
#ocean_spp_sum = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_spp_sum.rds"))
#ocean_spp_sum 
#ocean_spp_sum$statistic
```

```{r Anova ocean_spp}
an_ocean_spp = anova(ocean_spp, nBoot = 10, test = "LR")
...
#ocean_clusters_many
#ocean_clusters_sum = summary(ocean_clusters_many, nBoot=10)
#saveRDS(ocean_clusters_sum, here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_clusters_sum.rds"))

#ocean_clusters_sum = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_clusters_sum.rds"))
#ocean_clusters_sum 
#ocean_clusters_sum$statistic
```

```{r Anova ocean_clusters_many}

an_ocean_clusters_many = anova.traitglm(ocean_clusters_many, nBoot = 10, test = "LR")
...
#ocean_trait_many
#ocean_trait_sum = summary(ocean_trait_many, nBoot=10)
#saveRDS(ocean_trait_sum, here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_trait_sum.rds"))

#ocean_trait_sum = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_trait_sum.rds"))
#ocean_trait_sum
#ocean_trait_sum$statistic
```

```{r Anova ocean_trait_many}

an_ocean_trait_many = anova.traitglm(ocean_trait_many, nBoot = 10, test = "LR")
...
#ocean_full_many
#ocean_full_sum = summary(ocean_full_many, nBoot=10)
#saveRDS(ocean_full_sum, here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_sum.rds"))

#ocean_full_sum = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_sum.rds"))
#ocean_full_sum 
#ocean_full_sum$statistic
```

```{r Anova ocean_full_many}
an_ocean_full_many = anova.traitglm(ocean_full_many, nBoot = 10, test = "LR")
...
### Model: ocean_full_spp_many

```{r Model output ocean_full_spp_many}
#ocean_full_spp_many
#ocean_full_spp_sum = summary(ocean_full_spp_many, nBoot=10)
#saveRDS(ocean_full_spp_sum, here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_spp_sum.rds"))

#ocean_full_spp_sum = readRDS(here::here("outputs_figures/traitglms/ocean_models_2022_PA/ocean_full_spp_sum.rds"))
#ocean_full_spp_sum 
#ocean_full_spp_sum$statistic
```

```{r Anova ocean_full_spp_many}
an_ocean_full_spp_many = anova.traitglm(ocean_full_spp_many, nBoot = 10, test = "LR")
#saveRDS(an_ocean_full_spp_many, file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/an_ocean_full_spp_many.rds"))
#an_ocean_full_spp_many = readRDS(file = here::here("outputs_figures/traitglms/ocean_models_2022_PA/an_ocean_full_spp_many.rds"))
...
#anova_comp1 = anova.traitglm(ocean_full_spp_many , ocean_full_many, ocean_trait_many, ocean_clusters_many, nBoot = 10, test = "wald")
...
The species models had the lowest residual deviance explained, and typically higher AIC values. Traits models performed slightly better than cluster models, but not massive difference. Both cluster and trait sets of models outperformed species models.
...
```{r Make output graph, eval=FALSE}
...
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_PA/mod_dev_graph.pdf"), 
       plot = mod_dev_graph, width=8, height=4, dpi=300)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_PA/mod_dev_graph.jpeg"), 
       plot = mod_dev_graph, width=, height=4, dpi=300)

```

```{r LASSO summary call trial, eval=FALSE}
summary(ocean_spp_LASSO)
summary(ocean_trait_LASSO)
summary(ocean_cluster_LASSO)
```

### Model list - LASSO

Prints the lambda and deviance.
...
```{r Make output dataframe LASSO, eval=FALSE}
...
```{r Make output graph LASSO, eval=FALSE}
...
ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_PA/mod_dev_graph_lasso.pdf"), 
       plot = mod_dev_graph_lasso, width=6, height=4, dpi=300)

ggsave(here::here("outputs_figures/traitglms/ocean_models_2022_PA/mod_dev_graph_lasso.jpeg"), 
       plot = mod_dev_graph_lasso, width=6, height=4, dpi=300)
