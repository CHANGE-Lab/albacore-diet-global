...
This document contains code for manipulating trait and diet data sets for albacore prey species from our global meta-analysis of albacore diet composition.
...
write.csv(prey_length_wide, here("data/output_data/prey_length_wide.csv"))
```
...
write.csv(prey_length_ratiosp, here("data/output_data/prey_length_ratiosp.csv"))
...
alb_covars = alb_global %>%
  ...
  distinct(StudyID, CiteYear, OceanBasinQ, LocatName, LocatLatitude, LocatLongitude, YearEnd, MonthRange, stomachs_used, pred_life) %>% 
  #, stomachs_used
