...
```{r create base map, message=FALSE}
# Base map
...
```{r Add Longhurst Province Shp, message=FALSE}
...
```{r read in and manipulate albacore data}
...
```{r make albacore study data map}
