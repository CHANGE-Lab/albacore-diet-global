...
index_cluster_bar = index_alb_diet_clust_data %>%
  ...
  scale_fill_manual(values=fig3.pal, name="Prey Trait Guilds",
                    labels = c("1 (non-diel migrating mesopelagics)", "2 (diel migrating mesopelagics)", "3 (coastal and shelf epipelagics)",
                            "4 (coastal and shelf demersals)", "5 (oceanic epipelagics)", "6 (seasonal, continental shelf)", 
                            "7 (resident continental shelf)", "NA (not classified)")) +
...
ggsave(here::here("outputs_figures/diet_comp/index_cluster_barFO.jpeg"), plot = index_cluster_bar, width = 42, height = 33, dpi = 300)
...
ggsave(here::here("outputs_figures/diet_comp/diet_cluster_scatterFO.jpeg"), plot = index_cluster_scatter, width = 24, height = 16, dpi = 300)
