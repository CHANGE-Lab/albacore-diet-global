...
Here we will calculate a normalised metric or index for diet composition, of relative contribution to the total frequency of occurrence of all species’ within each trait guild, normalised for each replicate diet observation.
...
ggsave(here::here("outputs_figures/4_diet_comp/index_cluster_barFO_b.jpeg"), plot = index_cluster_bar, width = 34, height = 31, dpi = 150)
ggsave(here::here("outputs_figures/ms_figures/fig4_dietcomp/index_cluster_barFO_b.jpeg"), plot = index_cluster_bar, width = 34, height = 31, dpi = 150)

ggsave(here::here("outputs_figures/4_diet_comp/index_cluster_barFO_b2.jpeg"), plot = index_cluster_bar, width = 48, height = 32, dpi = 300)
ggsave(here::here("outputs_figures/ms_figures/fig4_dietcomp/index_cluster_barFO_b2.jpeg"), plot = index_cluster_bar, width = 48, height = 32, dpi = 300)
```
