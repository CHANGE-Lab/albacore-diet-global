...
## PROBABLE Divisive k = 6, excl. refuge use
### Cluster Dendrograms ---
...
#Using agglomerative hierarchical clustering, k = 8
prob.dendro <- as.dendrogram(prob.divisive.clust) #156 species
PNW.pal8 <- pnw_palette(6, name = "Bay", type = "continuous")
###Horizontal dendrogram - Probable traits

#Horizontal cluster illustration version
prob.dendro.col <- prob.dendro %>%
  set("branches_k_color", k = 6, value = PNW.pal8) %>%
  set("branches_lwd", 0.8) %>%
  set("labels", probable_species) %>% #NOT VERY LEGIBLE...
  set("labels_colors", 
      value = c("darkslategray")) %>% 
...
ggsave(here('outputs_figures/clusters/probable_divis_simple/prob.dendro.horz.k6.png'), plot=prob.dendro.graph, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_divis_simple/prob.dendro.rad.k6.png'), plot=prob.dendro.rad, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_divis_simple/prob.dendro.vertlabs.k6.pdf'), plot=ggd1, width=5, height=20, dpi=300)
...
prob.dendro.vert 
#Export as .png
ggsave(here('outputs_figures/clusters/probable_divis_simple/prob.dendro.vert2.k6.png'), plot=prob.dendro.vert, width=5, height=12, dpi=300)
...
#write.csv(prob.prey.cl, here("data/output_data/prob.prey.clusternum_habgreg.divis.k8.csv"))
write.csv(prob.prey.cl, here("outputs_figures/clusters/probable_divis_simple/prob.prey.clusternum_habgreg.divis.k6.csv"))
