...
```{r NMDS & Clusters ~ Species, tidy=TRUE, warning=FALSE, message=FALSE, results='hide'}
...
```{r Data scores for plotting - USE, warning=FALSE, message=FALSE}
...
```{r nMDS Cluster #,warning=FALSE, message=FALSE}
...
```{r nMDS Cluster + FO, warning=FALSE, message=FALSE}
