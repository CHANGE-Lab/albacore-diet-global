...
```{r Optional factor simplification, eval=FALSE}
##OPTIONAL DATA MANIPS
#Change bathypelagic to mesopelagic
#evels(prey_probable$vert_habitat)
#prey_probable$vert_habitat <- factor(prey_probable$vert_habitat, levels = c("bathypelagic", "benthic",      "demersal", "epipelagic", "mesopelagic"), labels = c("mesopelagic", "benthic",      "demersal", "epipelagic", "mesopelagic"))

#Change reef-associated to 
#levels(prey_probable$horz_habitat)
#prey_probable$horz_habitat <- factor(prey_probable$horz_habitat, levels = c("coastal", "continental shelf", "continental slope", "oceanic", "reef-associated"), labels = c("coastal", "continental shelf", "continental slope", "oceanic", "coastal"))
```
...
* Elbow method (20/03/2021) using habitat use + gregarious (binary) inflection at 8

* Silhouette (20/03/2021) using habitat use + gregarious (binary) inflection at 8
...
ggsave(here('outputs_figures/clusters/probable_agglo/prob.dendro.horz.k8.png'), plot=prob.dendro.graph, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_agglo/prob.dendro.rad.k8.png'), plot=prob.dendro.rad, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_agglo/prob.dendro.vertlabs.k8.pdf'), plot=ggd1, width=5, height=20, dpi=300)
...
prob.dendro.vert 
#Export as .png
ggsave(here('outputs_figures/clusters/probable_agglo/prob.dendro.vert2.k8.png'), plot=prob.dendro.vert, width=5, height=12, dpi=300)
...
write.csv(prob.prey.cl, here("outputs_figures/clusters/probable_agglo/prob.prey.clusternum_habgreg.aggl.k8.csv"))
...
ggsave(here('outputs_figures/clusters/probable_agglo/prob.dendro.heatcounts.k8.life.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_agglo/prob.dendro.heatpercent.aggl.k8.life.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_divis/prob.dendro.horz.k8.png'), plot=prob.dendro.graph, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_divis/prob.dendro.rad.k8.png'), plot=prob.dendro.rad, width=8, height=8, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_divis/prob.dendro.vertlabs.k8.pdf'), plot=ggd1, width=5, height=20, dpi=300)
...
prob.dendro.vert 
#Export as .png
ggsave(here('outputs_figures/clusters/probable_divis/prob.dendro.vert2.k8.png'), plot=prob.dendro.vert, width=5, height=12, dpi=300)
...
#Extract cluster number to trait matrix
prob.clust.num <- cutree(prob.divisive.clust, k = 8)
...
write.csv(prob.prey.cl, here("outputs_figures/clusters/probable_divis/prob.prey.clusternum_habgreg.divis.k8.csv"))
...
ggsave(here('outputs_figures/clusters/probable_divis/prob.dendro.heatcounts.divis.k8.life.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/probable_divis/prob.dendro.heatpercent.divis.k8.life.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
...
ggsave(here("outputs_figures/clusters/probable_divis/trait_nMDS_prob_clusters.png"), 
       plot = trait_nMDS_prob_fig, width = 8, height = 8, dpi = 300)
...
trait_nMDS_prob_fo <- ggplot() + 
  ...
  #guides(fill = FALSE, colour = FALSE) +
  #guides(fill = guide_legend(order = 1), colour = guide_legend(order = 2)) +
  scale_colour_viridis(option="B", begin = 0.2, end = 0.8, name = "Frequency of Occurrence (%)") + 
  scale_fill_viridis(option="magma", begin = 0.8, end = 0.2, name = "Cluster Number") #+
