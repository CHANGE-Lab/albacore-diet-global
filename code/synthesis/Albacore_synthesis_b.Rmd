...
ggsave(here('outputs_figures/clusters/prob.dendro.heatcounts.k8.life.pdf'), plot=heatmap.c, width=8, height=12, dpi=300)
...
ggsave(here('outputs_figures/clusters/prob.dendro.heatpercent.aggl.k8.life.pdf'), plot=heatmap.p, width=8, height=12, dpi=300)
