...
```{r working environment, echo=FALSE, results=hide}
#getwd()
#eval=FALSE, 
...
ggsave("prob_class.png",
  ...
  plot=prob_class, width=10, height=10, dpi=300)

ggsave("prob_class_lab.png",
  #here('./output_figures/diet_phylo/prey_prob/prob_class_lab.png'), 
  plot=prob_class_lab, width=8, height=8, dpi=300)
...
prob_maxfo <- gheatmap(prob_class, my_prey_prob[,"maxFO", drop = FALSE], 
  ...
  scale_fill_viridis_c(name = "Percent frequency consumed (%)", na.value = 'grey')
...
prob_maxn <- gheatmap(prob_class, my_prey_prob[,"maxN", drop = FALSE], 
                      offset = 0, width = 0.05, colnames = FALSE) +
  scale_fill_viridis_c(name = "Percent abundance consumed (% n)", na.value = 'grey')
...
prob_maxm <- gheatmap(prob_class, my_prey_prob[,"maxM", drop = FALSE], 
                      offset = 0, width = 0.05, colnames = FALSE) +
  scale_fill_viridis_c(name = "Percent biomass consumed (% kg)", na.value = 'grey')
...
habitat_traits_prob_final <- gheatmap(habitat_traits_prob3.5, my_prey_prob[ ,'refuge',drop=FALSE], offset=0.15, width=0.05, colnames = F)+
  ...
  theme(legend.position = c(1,0.531),
        ...
        legend.text = element_text(size = 18))+
  scale_y_continuous(expand = c(0,4))+
  annotate('text', x = 1.18, y = -7.5, label = 'RF', angle = -85, size = 4)
...
ggsave("prob_hab4.png",
       ...
       plot=habitat_traits_prob_final, width=13, height=10, dpi=300)
