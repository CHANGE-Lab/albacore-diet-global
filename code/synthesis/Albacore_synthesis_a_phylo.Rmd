...
behav_trophic_prob_final <- gheatmap(behav_trophic_prob2.5, my_prey_prob[ ,'season_migrant',drop=FALSE], offset=0.10, width=0.05, colnames = F) +
  ...
  theme(legend.position = c(1,0.5985))+
  scale_y_continuous(expand = c(0,4))+
  annotate('text', x = 1.14, y = -6.5, label = 'SM', angle = -85, size = 4)
...
ggsave("prob_behav1.png",
       ...
       plot=behav_trophic_prob1, width=12, height=10, dpi=300)
#Save graph 2
ggsave("prob_behav2.png",
       #here('./output_figures/diet_phylo/prey_prob/prob_behav2.png'), 
       plot=behav_trophic_prob2, width=12, height=10, dpi=300)
#Save graph 3
ggsave("prob_behav3.png",
       #here('./output_figures/diet_phylo/prey_prob/prob_behav3.png'),
       plot=behav_trophic_prob_final, width=12, height=10, dpi=300)
