...
```{r load prey info data, tidy=TRUE}
...
```{r Building basic tree, eval=FALSE}
...
```{r Prep tree to plot #1, tidy=TRUE}
...
```{r Prep tree to plot #2, tidy=TRUE}
...
```{r Figure A Prey species basic, tidy=TRUE}
...
```{r Figure C Prey order basic, eval=FALSE}
...
```{r Figure D Prey family basic, eval=FALSE}
...
```{r Figure K Morphological - defense/avoid - NOT UPDATED, eval=FALSE}
...
```{r Figure L Prey Nutritional Quality - NOT UPDATED, eval=FALSE}
...
```{r Figure M Fisheries Status - NOT UPDATED, eval=FALSE}
