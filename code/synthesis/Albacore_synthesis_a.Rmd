...
#Produces average species accumulation curve
Plot <- accumcomp(PreyPA, y=PreyPAsite, factor='OceanBasin', method='exact', legend=FALSE, conditioned=TRUE)
Plot

#Produces cumulative species curves
Plot2 <- accumcomp(PreyPA, y=PreyPAsite, factor='OceanBasin', method='collector', legend=FALSE, conditioned=TRUE)
Plot2 
str(accum.data)
View(accum.data)
