...
Sp <- specnumber(PreyPAdata) #, PreySite$OceanBasinQ)
Sp
...
#      103            43           127           188            75            24 

#Ocean Basin Q - not using
#Mediterranean   NE Atlantic    NE Pacific   NW Atlantic     NW Indian    NW Pacific   SE Atlantic   SW Atlantic     SW Indian    SW Pacific
#           43           111           172            18            22            25            65            15           100            24

temp_accum = specaccum(PreyPAdata, method = "collector", conditioned = TRUE)

# Acummresult function

#Produces average species accumulation curve
Alb.accum <- accumresult(PreyPAdata, y=PreyPAsite, #Ocean, 
...
#Produces average species accumulation curve
Plot <- accumcomp(PreyPAdata, y=PreyPAsite, 
                  factor='OceanBasin', method='exact', legend=FALSE, conditioned=TRUE)
Plot
