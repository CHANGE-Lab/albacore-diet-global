...
mod_type = c("species*env", "species*env", "species*env", 
             "trait*env", "trait*env", "trait*env",
             "cluster*env", "cluster*env", "cluster*env")
...
mod_dev_graph = ggplot(data = mod_dev) + 
  geom_bar(aes(y = deviance, color = mod_type)) + 
  #facet_grid(.~ mod_type)
  facet_grid(.~ covar)

mod_dev_graph

ggsave(here("outputs_figures/traitglms/prob_all_simple/mod_dev_graph.pdf"), 
       plot = mod_dev_graph, width=5, height=4, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_all_simple/mod_dev_graph.jpeg"), 
       plot = mod_dev_graph, width=5, height=4, dpi=300)
