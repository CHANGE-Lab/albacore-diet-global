...
#LASSO glms
prob_life_cluster_LASSO = readRDS(here("outputs_figures/traitglms/prob_life_stage/prob_life_cluster_LASSO.rds"))
prob_ocean_cluster_LASSO = readRDS(here("outputs_figures/traitglms/prob_life_stage/prob_ocean_cluster_LASSO.rds"))
...
prob_trait_lat_many = readRDS(here("outputs_figures/traitglms/prob_life_stage/prob_trait_lat_many.rds"))

#LASSO glms
prob_life_trait_LASSO = readRDS(here("outputs_figures/traitglms/prob_life_stage/prob_life_trait_LASSO.rds"))
prob_ocean_trait_LASSO = readRDS(here("outputs_figures/traitglms/prob_life_stage/prob_ocean_trait_LASSO.rds"))
prob_trait_lat_LASSO = readRDS(here("outputs_figures/traitglms/prob_life_stage/prob_trait_lat_LASSO.rds"))
...
```{r SPP latitude manyglm, eval=FALSE}
...
Not done yet. Latitude models had lower explanatory power than ocean basin or predator life stage.
...
prob_trait_lat_many <-  traitglm(L = alb_prob_preyPA_mv,
                            R = alb_prob_covars$lat_cat,
                            Q = traits_use[,1:6],
                            family=binomial(link = "logit")
                            ) #note default is "manyglm"
...
a        = max( abs(prob_trait_lat_many$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(prob_trait_lat_many$fourth.corner))

rownames(temp) = c("Tropical")

prob_trait_lat_many_graph = levelplot(temp, 
...
print(prob_trait_lat_many_graph)
...
prob_trait_lat_LASSO <-  traitglm(L = alb_prob_preyPA_mv,
                            R = alb_prob_covars$lat_cat,
                            Q = traits_use[,1:6],
                            family=binomial(link = "logit"),
                            method="glm1path"
...
a        = max( abs(prob_trait_lat_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(prob_trait_lat_LASSO$fourth.corner))
...
prob_trait_lat_LASSO_graph = levelplot(temp, 
                     xlab=list("Temperate vs. Tropical", cex=1.5),
                     ylab=list("Species traits", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(prob_trait_lat_LASSO_graph)
#trait_lat_4th = as.ggplot(trait_lat_4th)
...
saveRDS(prob_trait_lat_many, file = here("outputs_figures/traitglms/prob_life_stage/prob_trait_lat_many.rds"))

#LASSO glms
saveRDS(prob_life_trait_LASSO, file = here("outputs_figures/traitglms/prob_life_stage/prob_life_trait_LASSO.rds"))
saveRDS(prob_ocean_trait_LASSO, file = here("outputs_figures/traitglms/prob_life_stage/prob_ocean_trait_LASSO.rds"))
saveRDS(prob_trait_lat_LASSO, file = here("outputs_figures/traitglms/prob_life_stage/prob_trait_lat_LASSO.rds"))
...
##### Model: prob_trait_lat_many

```{r Model Output prob_trait_lat_many}
prob_trait_lat_many
```
