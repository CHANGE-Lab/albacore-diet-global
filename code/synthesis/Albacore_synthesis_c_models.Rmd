...
prob_life_trait_many_4th_graph = levelplot(temp, 
                     xlab=list("Predator Life Stage", cex=1.5),
...
print(prob_life_trait_many_4th_graph)

ggsave(here("outputs_figures/traitglms/prob_all_simple/prob_life_trait_many_4th_graph.pdf"), plot = as.ggplot(prob_life_trait_many_4th_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_all_simple/prob_life_trait_many_4th_graph.jpeg"), 
       plot = as.ggplot(prob_life_trait_many_4th_graph), width=12, height=12, dpi=300)
...
prob_life_trait_LASSO_graph = levelplot(temp, 
                     xlab=list("Predator Life Stage", cex=1.5),
                     ylab=list("Species traits", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(prob_life_trait_LASSO_graph)

ggsave(here("outputs_figures/traitglms/prob_all_simple/prob_life_trait_LASSO_graph.pdf"), 
       plot = as.ggplot(prob_life_trait_LASSO_graph), width=12, height=12, dpi=300)

ggsave(here("outputs_figures/traitglms/prob_all_simple/prob_life_trait_LASSO_graph.jpeg"), 
       plot = as.ggplot(prob_life_trait_LASSO_graph), width=12, height=12, dpi=300)
