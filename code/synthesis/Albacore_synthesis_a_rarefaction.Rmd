...
#  Package ‘lattice’ version 0.20.44 cannot be unloaded:
# Error in unloadNamespace(package) : namespace ‘lattice’ is imported by ‘ape’, ‘sp’, ‘nlme’ so cannot be unloaded
...
```{r Rarefaction specnumber and accumresult}
...
```{r Rarefaction by sites - exact method}
