...
```{r Trait factor levels, warning=FALSE, message=FALSE, eval=FALSE, include=FALSE}
...
## Trait models extra code

*Note:* that the 'Albacore_synthesis_c_extra.Rmd' doc also contains additional code to evaluate these models and for plotting the species models. This code is to save outputs of model build.
...
We need to officially compare model outputs thematically based on using the same datasets.
...
#saveRDS(anova.life1, file = here("outputs_figures/traitglms/prob_models/anova.life1.rds"))
anova.life1 = readRDS(here("outputs_figures/traitglms/prob_models/anova.life1.rds"))
anova.life1
...
anova.life2 = readRDS(here("outputs_figures/traitglms/prob_models/anova.life2.rds"))
anova.life2
