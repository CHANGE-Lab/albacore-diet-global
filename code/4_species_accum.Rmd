...
alb_global_dietpa = read.csv(here("data/2_output_data/alb_global_wide_dietpa.csv"), 
          check.names = FALSE) %>%
  group_by(OceanBasin) %>%
  arrange(YearEnd)
...
ggsave(here("outputs_figures/ms_figures/fig1_map_spp/alb_mean_accum_legend.jpeg"), plot=plotgg1, height = 8, width = 12, dpi = 300)
...
ggsave(here("outputs_figures/ms_figures/fig1_map_spp/alb_step_accum_simple.jpeg"), 
...
ggsave(here("outputs_figures/ms_figures/fig1_map_spp/alb_step_accum_year_nl.jpeg"), plot=plotgg3, height = 8, width = 12, dpi = 300)
...
ggsave(here("outputs_figures/ms_figures/fig1_map_spp/accum.plot1.jpeg"), plot=Accum.plot, height = 8, width = 12, dpi = 300)
```
