...
Species mean species accumulation and step-wise accumulation in relation to collection sites:
...
accumplot(Alb.accum)
#Makes a dataset with species richness in relation to sites using the 'exact' method.
#This adds sites randomly, and finds the expected mean number of sites that contribute to 
#a certain increase in species richness.
str(Alb.accum)
...
#Makes a dataset with species richness in relation to sites using the 'collector' method.
#This adds sites in the order they are collected, and finds the expected mean number of sites that contribute to 
#a certain increase in species richness.
str(Alb.accum2)
