...
#L - species df
alb_prey_pa_use = read.csv(here::here("./data/2_output_data/alb_prey_pa_use_longhurst.csv"))
dim(alb_prey_pa_use)
...
#R - covars df
alb_covars_use = read.csv(here::here("./data/2_output_data/alb_covars_longhurst.csv"))
...
#Q - trait df
alb_trait_use = read.csv(here::here("./data/2_output_data/alb_trait_use_longhurst.csv")) #%>%
#  select(-X)
...
unique(alb_covars_use$code) #4 Ocean basins
...
long_spp <- traitglm(L = alb_prey_pa_use_mv,
                      R = alb_covars_use$code,
...
qqnorm(residuals(long_spp)[which(residuals(long_spp)<10000)]); abline(c(0,1),col="red")

#omit non-finite residuals FULL MODEL
resids.full = residuals(long_spp)[is.finite((residuals(long_spp)))]
...
long_spp_LASSO <- traitglm(L = alb_prey_pa_use_mv,
                      R = alb_covars_use$code,
                      family=binomial(link = "logit"),
                      method="glm1path",
                      composition = TRUE,
...
long_clusters_many <- traitglm(L = alb_prey_pa_use_mv,
                               R = alb_covars_use$code,
...
a        = max( abs(long_clusters_many$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(long_clusters_many$fourth.corner))

rownames(temp) = c(#"Mediterranean",
                   "Mediterranean",
                   "North Atlantic Drift"#, "S Pacific"
                   )

colnames(temp)

long_clusters_many_graph = levelplot(temp, 
...
print(long_clusters_many_graph)

ggsave(here::here("outputs_figures/traitglms/long_models_2022_PA/long_clusters_many.pdf"), 
       plot = as.ggplot(long_clusters_many_graph), width=12, height=12, dpi=300)

ggsave(here::here("outputs_figures/traitglms/long_models_2022_PA/long_clusters_many_graph.jpeg"), 
       plot = as.ggplot(long_clusters_many_graph), width=12, height=12, dpi=300)
...
long_cluster_LASSO <- traitglm(L = alb_prey_pa_use_mv,
                               R = alb_covars_use$code,
                               Q = traits_use$cluster,
                               family=binomial(link = "logit"),
                               method="glm1path",
...
a        = max( abs(long_cluster_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(long_cluster_LASSO$fourth.corner))

rownames(temp) = c("California Current",
                   "Mediterranean",
...
long_cluster_LASSO_graph = levelplot(temp, 
                     xlab=list("", cex=1.5), #Ocean Basins
                     ylab=list("Trait Guilds", cex=1.5), 
                     col.regions=colort(100), 
                     at=seq(-a, a,length=100),
...
print(long_cluster_LASSO_graph)

ggsave(here::here("outputs_figures/traitglms/long_models_2022_PA/long_cluster_LASSO_graph.pdf"), 
       plot = as.ggplot(long_cluster_LASSO_graph), width=8, height=8, dpi=300)

ggsave(here::here("outputs_figures/traitglms/long_models_2022_PA/long_cluster_LASSO_graph.jpeg"), 
       plot = as.ggplot(long_cluster_LASSO_graph), width=8, height=8, dpi=300)
...
long_cluster_LASSO$coefficients#[86:97]
...
long_trait_many <- traitglm(L = alb_prey_pa_use_mv,
                             R = alb_covars_use$code,
...
a        = max( abs(long_trait_many$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(long_trait_many$fourth.corner))
...
long_trait_many_graph = levelplot(temp, 
                     xlab=list("", cex=1.5), #Ocean Basins
...
print(long_trait_many_graph)

ggsave(here::here("outputs_figures/traitglms/long_models_2022_PA/long_traits_many_graph.pdf"), 
       plot = as.ggplot(long_trait_many_graph), width=12, height=12, dpi=300)

ggsave(here::here("outputs_figures/traitglms/long_models_2022_PA/long_traits_many_graph.jpeg"), 
       plot = as.ggplot(long_trait_many_graph), width=12, height=12, dpi=300)
...
long_trait_LASSO <- traitglm(L = alb_prey_pa_use_mv,
                              R = alb_covars_use$code,
                              Q = traits_use[,1:4], #traits_use[,1:5]
                              family=binomial(link = "logit"),
                              method="glm1path",
...
a        = max( abs(long_trait_LASSO$fourth.corner) )
colort   = colorRampPalette(c("blue","grey","red")) #can replace "grey" with "white"
temp = t(as.matrix(long_trait_LASSO$fourth.corner))
...
long_LASSO_graph = levelplot(temp, 
                     xlab=list("", cex=1.5), #Ocean Basins
...
print(long_LASSO_graph)

ggsave(here::here("outputs_figures/traitglms/long_models_2022_PA/long_traits_LASSO_graph.pdf"), 
       plot = as.ggplot(long_LASSO_graph), width=12, height=8, dpi=300)

ggsave(here::here("outputs_figures/traitglms/long_models_2022_PA/long_traits_LASSO_graph.jpeg"), 
       plot = as.ggplot(long_LASSO_graph), width=12, height=8, dpi=300)
...
#Manyglm
saveRDS(long_spp, file = here::here("outputs_figures/traitglms/long_models_2022_PA/long_spp.rds"))
saveRDS(long_clusters_many, file = here::here("outputs_figures/traitglms/long_models_2022_PA/long_clusters_many.rds"))
saveRDS(long_trait_many, file = here::here("outputs_figures/traitglms/long_models_2022_PA/long_trait_many.rds"))

#LASSO glms
saveRDS(long_spp_LASSO, file = here::here("outputs_figures/traitglms/long_models_2022_PA/long_spp_LASSO.rds"))
saveRDS(long_cluster_LASSO, file = here::here("outputs_figures/traitglms/long_models_2022_PA/long_cluster_LASSO.rds"))
saveRDS(long_trait_LASSO, file = here::here("outputs_figures/traitglms/long_models_2022_PA/long_trait_LASSO.rds"))
...
#PA
alb_pa_ord_long = metaMDS(alb_prey_pa_use_longhurst,
                     distance="jaccard",
                     #trymax=20,
                     trymax = 1000,#10000, #1000
                     k=3) #could increase to k = 4

saveRDS(alb_pa_ord_long, here::here("outputs_figures/traitglms/alb_pa_ord_long.rds"))

#Note pb with this!! insufficient data?

pl <- ordiplot(alb_pa_ord_long, type = "none")
...
data.scores <- as.data.frame(scores(alb_pa_ord_long))  #, "species"
...
treatment.scores <- cbind(alb_covars_use_longhurst, data.scores)
#Check
...
ggsave(here("outputs_figures/traitglms/long_models_2022/nMDS_ocean.jpeg"), 
